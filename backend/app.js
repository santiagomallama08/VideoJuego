...
const authRoutes = require('./routes/authRoutes') // ✅ añadida para login/register
...
app.get('/', (req, res) => {
    res.send(`
        ...
        <p>🔐 Para login: /api/auth/login</p>
        <p>🆕 Para registro: /api/auth/register</p>
        `)
});

// Rutas
app.use('/api/blocks', blockRoutes)
app.use('/api/auth', authRoutes) // ✅ rutas del login
